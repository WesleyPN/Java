...
public class telaIdade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons8-nome-100.png"))); // NOI18N
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jLabel2.setText("Ano de nascimento:");

        txtAno.setModel(new javax.swing.SpinnerNumberModel(1900, 1900, atual, 1));

        jLabel3.setText("Ano atual:");

        lblAA.setFont(new java.awt.Font("Liberation Sans", 1, 18)); // NOI18N
        lblAA.setForeground(new java.awt.Color(0, 153, 0));
        lblAA.setText(Integer.toString(atual));

        btnCalcula.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons8-calculadora-48.png"))); // NOI18N
